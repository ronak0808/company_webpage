...
from app.models import GenralInfo,Service,Testimonial,ContactFormLog,Blog
...
def index(request):
    general_info=GenralInfo.objects.first()
...
def blogs(request):
    ...
    try:
        pblogs=paginator.page(page)
    except PageNotAnInteger:
        pblogs=paginator.page(1)
    except EmptyPage:
        pblogs=paginator.page(paginator.num_pages)
